                        ...
                        <div class="card-header">
                            <form method="POST" action="">
                                <div class="form-group">
                                    <label for="serialCode">Enter Serial Code:</label>
                                    <input type="text" name="serialCode" id="serialCode" class="form-control" required>
                                </div>
                                ...
                                <table id="example-2" class="table table-bordered key-buttons text-nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_POST['search'])) {
                                            $serialCode = mysqli_real_escape_string($conn, $_POST['serialCode']);
                                            $counter = 1;                   
                                            $projectlist = "SELECT * FROM `tbl_pin_codes` WHERE SerialCode = '$serialCode' and Status='Active'";
                                            ...
                                            if (mysqli_num_rows($resultclist) > 0) {
                                                while ($rows = mysqli_fetch_array($resultclist)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="UpdateStatus.php?product=<?php echo $rows["pin_id"];?>">
